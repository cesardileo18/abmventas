...
$venta = new Venta();
$facturacionMes = $venta->facturacionMensual(date('m'));
$facturacionAnual = $venta->facturacionAnual(date('Y'));
...
<?php include_once("nav.php"); ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="generarreporte.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generar Reporte</a>
          </div>
